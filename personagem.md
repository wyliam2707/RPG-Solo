...
- Sua experiência como mago é **superior a um século**. Em jogo, um demônio antigo afirmou estar preso por Wyliam há aproximadamente **127 anos**, o que confirma uma história pessoal muito mais longa do que sua aparência necessariamente sugere.
- Wyliam usa **meditação como sua versão de dormir**: o corpo descansa, a mente se reorganiza e uma parcela da consciência pode permanecer em vigilância quando necessário.
...
- Ele foi expelido de sua realidade por uma reação extrema de **Paradoxo**.
- Apesar disso, por estar no auge de sua capacidade, conseguiu de alguma forma sobreviver e chegar ao universo atual.
- Os detalhes exatos de como ocorreu a expulsão e a travessia ainda não estão definidos e podem ser construídos narrativamente.

## Natureza da magia
- A magia segue a lógica de que **a vontade ajusta a realidade**.
- O personagem não depende de uma lista fixa de feitiços; ele força a realidade a assumir uma configuração desejada.
- A preferência do personagem é por magia **sutil, coincidente e plausível**, fazendo os efeitos parecerem acontecimentos naturais, acidentes, coincidências, tecnologia, poderes ou outros fenômenos compatíveis com o mundo.
- A realidade atual já admite mutantes, magia, tecnologia impossível, alienígenas e superpoderes. Portanto, efeitos ostensivos que possam ser confundidos de maneira razoável com uma mutação, poder meta-humano ou fenômeno já aceito pelo mundo podem ser tratados como magia aberta sem necessariamente provocar Paradoxo relevante.
- Sua experiência centenária aparece menos como necessidade de espetáculo e mais como precisão: ele prefere reorganizar funções, contornar resistências, falsificar estados coerentes, aproveitar regras já existentes e fazer o impossível parecer inevitável antes de recorrer à força bruta.

## Paradoxo neste universo
- O Paradoxo não é uma barra, recurso numérico ou sistema mecânico.
- Ele é uma **reação narrativa da realidade** quando o personagem força demais suas leis ou cria uma distorção grande demais para ser absorvida pelo contexto do mundo.
- Pequenas coincidências e alterações sutis devem ser aceitas com naturalidade quando coerentes com a cena.
- Efeitos ostensivos, mas compatíveis com poderes conhecidos neste universo, podem ser ignorados pela realidade ou gerar pouca resistência.
...
- O narrador deve observar quando o personagem começa a exagerar, acumular distorções ou agir como se não houvesse consequência para manipular a realidade.
- Quando isso acontecer, o narrador deve aplicar uma **reação de Paradoxo rápida, física e narrativa**, capaz de alterar imediatamente a situação e empurrar a história em uma nova direção.
- Essas consequências não devem ser arbitrárias nem usadas apenas para impedir o jogador; devem nascer da natureza e da escala da distorção criada.
...
- **Dinheiro, status e poder político não são objetivos importantes**.
...
- Apesar de sua irreverência e de não se considerar um herói exemplar, ainda conserva um **impulso genuíno de ajudar**.
