# Poderes — Convenções Narrativas

## Princípio geral: magia velada por padrão
- Todos os poderes e efeitos mágicos do personagem são tratados como **velados por padrão**, resultado de muitos anos de hábito e refinamento.
- Quando o jogador descreve uma intenção mágica sem especificar que deseja torná-la ostensiva, o narrador deve presumir que o personagem executa o efeito da forma mais discreta, natural e plausível que sua experiência permitir.
- **Velado** descreve a forma de manifestação e a tentativa de esconder a intervenção mágica; não significa que o resultado precise ser pequeno ou inofensivo.
- Exemplo: “vou destravar a porta usando magia” é velado por padrão. O resultado pode parecer uma fechadura que cedeu, um mecanismo que estava mal encaixado ou outra explicação plausível.
- Exemplo: “vou destruir as dobradiças com magia” também é velado por padrão. O personagem procura fazer o dano parecer uma falha estrutural, desgaste, pressão, impacto ou outro acontecimento compatível com a cena.
- O jogador não precisa repetir em toda ação que está escondendo a magia. A sutileza é o comportamento automático do personagem.

## Abordagens de manifestação

### 1. Coincidente / velada
- É a abordagem padrão quando o efeito pode ser explicado por coincidência, falha mecânica, acidente, reação natural, erro humano, desgaste, sorte, azar ou outro acontecimento plausível.
- O narrador deve preferir essa leitura sempre que a intenção do jogador permitir.
- O efeito pode ser forte, mas sua causa permanece disfarçada.

### 2. Aberta
- Um efeito é **aberto** quando sua manifestação não pode ser honestamente escondida como simples coincidência ou evento natural, mas ainda se encaixa no repertório de poderes aceitos neste universo ou naquele contexto local.
- Exemplos: lançar um raio de energia, tornar-se invisível, abrir um portal, erguer-se no ar, criar um campo de força ou manifestar outro efeito visivelmente sobrenatural.
- Para uma testemunha comum, isso pode ser interpretado como mutação, poder meta-humano, tecnologia avançada, magia conhecida ou alguma capacidade extraordinária semelhante.
- O simples fato de ser aberto **não o torna automaticamente vulgar** e não deve, por si só, provocar uma reação severa de Paradoxo.
...
## Consenso e contexto local
- A classificação entre **aberto** e **vulgar** depende também do lugar em que o efeito ocorre.
- Ambientes fortemente mágicos, realidades alternativas, dimensões sobrenaturais, santuários arcanos e locais onde magia ostensiva faz parte da ordem normal das coisas possuem um **consenso local mais permissivo**.
- Em lugares assim, efeitos que seriam extremamente estranhos em uma rua comum podem ser tratados apenas como magia aberta e gerar pouca ou nenhuma pressão de Paradoxo.
- **Kamar-Taj** é a principal referência: portais, projeções, encantamentos visíveis, manipulação de energia e outras manifestações mágicas são parte natural do ambiente. Ali, o limiar para um efeito ser considerado vulgar é muito mais alto.
...
## Poderoso não significa absoluto
- Magia coincidente ou aberta pode ser **extremamente poderosa**, mas enquanto permanecer não vulgar ela não deve ser tratada como absoluta.
- Cada efeito pode possuir condições naturais de funcionamento, requisitos, âncoras, limites ou resistências coerentes com sua natureza e com o cenário.
- Teleporte, por exemplo, pode exigir que o personagem conheça o destino, já tenha estado ali, possua uma referência suficientemente precisa, encontre uma âncora adequada ou consiga estabelecer uma conexão com o local.
- Um destino também pode estar protegido por barreiras, selos, interferências dimensionais, poderes de terceiros ou condições que impeçam a conexão.
...
- O alerta não precisa oferecer apenas a opção vulgar. Sempre que houver alternativas plausíveis dentro das regras — contornar, compreender, neutralizar, procurar outra rota, obter uma âncora ou enfrentar a resistência diretamente — elas continuam disponíveis ao jogador.
...
- Magia não vulgar pode ser poderosa, mas deve respeitar suas próprias condições, âncoras, resistências, barreiras e regras do cenário.
- Quando uma dessas limitações impedir o resultado, o narrador deve **interromper a resolução no obstáculo, explicar ao jogador o que o personagem percebe e devolver a decisão a ele**.
- Se o jogador exige que um efeito atravesse ou invalide **toda e qualquer resistência relevante sem interação, custo ou contestação**, o narrador deve tratá-lo como vulgar, após aplicar o Alerta de Limiar Vulgar quando a intenção inicial não era explicitamente vulgar.
